 ...
 * {@inheritDoc}
 */
int gnl_message_s_to_string(const struct gnl_message_s *message, char **dest) {
 ...
 * {@inheritDoc}
 */
int gnl_message_s_from_string(const char *message, struct gnl_message_s *message_s) {
    if (message_s == NULL) {
        errno = EINVAL;

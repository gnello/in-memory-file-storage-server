 ...
 *                      -1 otherwise.
 */
extern int gnl_message_sb_to_string(struct gnl_message_sb *message_sb, char **dest);
 ...
 */
extern int gnl_message_sb_from_string(const char *message, struct gnl_message_sb *message_sb);

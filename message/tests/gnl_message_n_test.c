...
int can_read_message() {
    ...
    int res = gnl_message_n_read(message, message_n);
...
int main() {
    ...
    gnl_assert(can_build_message, "can build a message from a gnl_message_n struct.");
    gnl_assert(can_read_message, "can read a message into a gnl_message_n struct.");

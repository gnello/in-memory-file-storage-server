...
int main() {
    ...
    gnl_assert(can_to_string_message, "can get a message string from a gnl_message_n struct.");
    gnl_assert(can_from_string_message, "can get a message from a string into a gnl_message_n struct.");

    // the gnl_message_n_destroy method is implicitly tested in every assertion

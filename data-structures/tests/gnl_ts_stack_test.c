...
int can_create_a_ts_stack() {
    ...
    gnl_ts_stack_destroy(stack, NULL);
...
int can_push_an_int() {
    ...
    gnl_ts_stack_push(stack, &test_int_el1);
...
int can_push_a_string() {
    ...
    gnl_ts_stack_push(stack, test_string_el1);
...
int can_destroy_stack_complex_struct() {
    ...
    gnl_ts_stack_push(stack, test_complex_struct_init());
    gnl_ts_stack_push(stack, test_complex_struct_init());
    gnl_ts_stack_push(stack, test_complex_struct_init());
    gnl_ts_stack_push(stack, test_complex_struct_init());
    gnl_ts_stack_push(stack, test_complex_struct_init());
    ...
    gnl_ts_stack_destroy(stack, free);
...
int main() {
    ...
    gnl_assert(can_destroy_stack_complex_struct, "can destroy a complex struct elements thread-safe stack.");
